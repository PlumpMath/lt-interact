...
lt.plugins.interact.new_val_in_QMARK_ = (function new_val_in_QMARK_(ks,old,new$){var old_val = cljs.core.get_in.call(null,old,ks);var new_val = cljs.core.get_in.call(null,new$,ks);if(cljs.core.truth_((function (){var and__8635__auto__ = new_val;if(cljs.core.truth_(and__8635__auto__))
{return cljs.core.not_EQ_.call(null,old_val,new_val);
} else
{return and__8635__auto__;
}
})()))
{return new_val;
} else
...
lt.plugins.interact.cmd_process = (function cmd_process(cmd,args,cb){var o = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.interact","runner","lt.plugins.interact/runner",2426861730),cmd,args);var k = cljs.core.gensym.call(null,cmd);cljs.core.add_watch.call(null,o,k,(function (_,___$1,old,new$){var temp__4092__auto___9800 = lt.plugins.interact.new_val_in_QMARK_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"proc","proc",1017353928),new cljs.core.Keyword(null,"out","out",1014014656)], null),old,new$);if(cljs.core.truth_(temp__4092__auto___9800))
{var new_out_9801 = temp__4092__auto___9800;cb.call(null,new_out_9801,null);
...
lt.plugins.interact.text_input = (function text_input(default_value){var e__8087__auto__ = crate.core.html.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",1114262332),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1017479852),"text",new cljs.core.Keyword(null,"value","value",1125876963),default_value], null)], null));var seq__9788_9802 = cljs.core.seq.call(null,cljs.core.partition.call(null,2,cljs.core.PersistentVector.EMPTY));var chunk__9789_9803 = null;var count__9790_9804 = 0;var i__9791_9805 = 0;while(true){
if((i__9791_9805 < count__9790_9804))
{var vec__9792_9806 = cljs.core._nth.call(null,chunk__9789_9803,i__9791_9805);var ev__8088__auto___9807 = cljs.core.nth.call(null,vec__9792_9806,0,null);var func__8089__auto___9808 = cljs.core.nth.call(null,vec__9792_9806,1,null);lt.util.dom.on.call(null,e__8087__auto__,ev__8088__auto___9807,func__8089__auto___9808);
{
var G__9809 = seq__9788_9802;
var G__9810 = chunk__9789_9803;
var G__9811 = count__9790_9804;
var G__9812 = (i__9791_9805 + 1);
seq__9788_9802 = G__9809;
chunk__9789_9803 = G__9810;
count__9790_9804 = G__9811;
i__9791_9805 = G__9812;
continue;
}
} else
{var temp__4092__auto___9813 = cljs.core.seq.call(null,seq__9788_9802);if(temp__4092__auto___9813)
{var seq__9788_9814__$1 = temp__4092__auto___9813;if(cljs.core.chunked_seq_QMARK_.call(null,seq__9788_9814__$1))
{var c__9376__auto___9815 = cljs.core.chunk_first.call(null,seq__9788_9814__$1);{
var G__9816 = cljs.core.chunk_rest.call(null,seq__9788_9814__$1);
var G__9817 = c__9376__auto___9815;
var G__9818 = cljs.core.count.call(null,c__9376__auto___9815);
var G__9819 = 0;
seq__9788_9802 = G__9816;
chunk__9789_9803 = G__9817;
count__9790_9804 = G__9818;
i__9791_9805 = G__9819;
continue;
}
} else
{var vec__9793_9820 = cljs.core.first.call(null,seq__9788_9814__$1);var ev__8088__auto___9821 = cljs.core.nth.call(null,vec__9793_9820,0,null);var func__8089__auto___9822 = cljs.core.nth.call(null,vec__9793_9820,1,null);lt.util.dom.on.call(null,e__8087__auto__,ev__8088__auto___9821,func__8089__auto___9822);
{
var G__9823 = cljs.core.next.call(null,seq__9788_9814__$1);
var G__9824 = null;
var G__9825 = 0;
var G__9826 = 0;
seq__9788_9802 = G__9823;
chunk__9789_9803 = G__9824;
count__9790_9804 = G__9825;
i__9791_9805 = G__9826;
continue;
}
}
} else
...
lt.plugins.interact.new_input = (function new_input(editor){var map__9796 = new cljs.core.Keyword(null,"interact.output-end","interact.output-end",1619479609).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,editor));var map__9796__$1 = ((cljs.core.seq_QMARK_.call(null,map__9796))?cljs.core.apply.call(null,cljs.core.hash_map,map__9796):map__9796);var end = map__9796__$1;var ch = cljs.core.get.call(null,map__9796__$1,new cljs.core.Keyword(null,"ch","ch",1013907415));var line = cljs.core.get.call(null,map__9796__$1,new cljs.core.Keyword(null,"line","line",1017226086));var lline = lt.objs.editor.last_line.call(null,editor);var vec__9797 = (((cljs.core.not.call(null,end)) && (cljs.core.not_EQ_.call(null,line,lline)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lline,1], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [line,ch], null));var line__$1 = cljs.core.nth.call(null,vec__9797,0,null);var ch__$1 = cljs.core.nth.call(null,vec__9797,1,null);var input = lt.objs.editor.line.call(null,editor,line__$1).slice((ch__$1 - 1));return input;
});
...
return (function (p1__9798_SHARP_,p2__9799_SHARP_){return cljs.core.get_in.call(null,cljs.core.deref.call(null,editor),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"interact.result-fn","interact.result-fn",4519767602)], null)).call(null,p1__9798_SHARP_,p2__9799_SHARP_);
});})(cmd,editor))
...
lt.plugins.interact.append_result = (function append_result(editor){return (function (output,error_output){lt.objs.editor.replace.call(null,editor,lt.plugins.interact.last_pos.call(null,editor),(function (){var or__8647__auto__ = output;if(cljs.core.truth_(or__8647__auto__))
{return or__8647__auto__;
} else
{return "";
}
})());
lt.objs.editor.replace.call(null,editor,lt.plugins.interact.last_pos.call(null,editor),(function (){var or__8647__auto__ = error_output;if(cljs.core.truth_(or__8647__auto__))
{return or__8647__auto__;
} else
{return "";
}
